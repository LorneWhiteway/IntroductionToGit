...
\begin{frame}{Source control...}
  \begin{block}{}
    \begin{itemize}
      ...
      \item{... protects you against damage to your files (e.g. hard drive failure, fire, flood, misplacement, accidental deletion, theft, virus, ransomware, ...).}
...
\begin{frame}{Repository $\leftrightarrow$ working directory (1)}
  \begin{block}{}
    \begin{itemize}
      \item{To see a description of the relationship between the repository and the working directory: \code{git status}.}
    \end{itemize}
  \end{block}
  \begin{block}{}
    \begin{center}
