...
\begin{frame}{This repository location isn't ideal...}
  \begin{block}{}
    \begin{itemize}
      \item{Having the git repository next to your working directory on your local directory isn't ideal:}
      \item{\ You don't get any protection against physical damage to the disk.}
...
\begin{frame}{Seeing the DAG}
  \begin{block}{}
  Run \code{gitk --all} to see the DAG (\& much other information).
    \begin{center}
...
\begin{frame}{Pointers to nodes - tags}
  \begin{block}{}
    A \textit{tag} is a label that is attached to a node.
    \begin{center}
